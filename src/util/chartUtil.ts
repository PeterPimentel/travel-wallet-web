...
export const getTotalExpensesByCategory = (expenses : Expense[], clean?: boolean): PieData[] => {
   const data = expenses.reduce((acc: PieData[], curr: Expense) => {
       switch (curr.type) {
           case "FOOD":
